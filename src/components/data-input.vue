...
const target_selected = (col: string) => {
  ...
  dataStore.instance = dataStore.data[instance_nr.value] //makes sure there is always an instance selected
...
const instance_selected = (nr: number) => {
  dataStore.instance = dataStore.data[nr]
}
...
<template>
  <div class="w-100">
    <div class="mx-3 align-center justify-center">
      ...
      <div class="d-flex align-center justify-center">
        <div class="w-50">
          <v-slider v-if="dataStore.target_feature !== ''" class="px-3 mt-5"
